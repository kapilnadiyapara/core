...
class UsersControllerTest extends \Test\TestCase {
	...
	public function testSetEmailAddressSendEmail($id, $mailaddress) {
		...
		$iL10->expects($this->atLeastOnce())
			->method('t')
			->willReturn('An email has been sent to this address for confirmation. Until email is verified this address will not be set.');
		$expectedResponse = new DataResponse(
			[
				'status' => 'success',
				'data' => [
					...
					'message' => 'An email has been sent to this address for confirmation. Until email is verified this address will not be set.'
				]
			],
			Http::STATUS_OK
		);
